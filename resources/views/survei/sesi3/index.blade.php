<x-layouts.app :title="$title" eyebrow="Survei — Sesi 3">
            ...
            <div class="rounded-sm border border-paper-300 bg-paper-50">
                <div class="flex items-center justify-between border-b border-paper-200 px-5 py-4">
                    ...
                    <div class="flex items-center gap-2">
                        <form method="POST" action="{{ route('survei.sesi3.salin.sesi2', $sesi->id) }}" onsubmit="return confirm('Tarik semua komoditas yang diproduksi di Sesi 2 ke daftar ini?')">
                            @csrf
                            <button type="submit"
                                ...
                                <div class="px-5 py-4">
                                    <div class="flex items-start justify-between mb-3">
                                        ...
                                        <div class="flex items-center gap-2 ml-4 flex-shrink-0">
                                            ...
                                            <form method="POST" action="{{ route('survei.sesi3.standar.destroy', $sesi->id) }}"
        ...
        <div class="space-y-4">
            ...
            <div class="rounded-sm border border-paper-300 bg-paper-50">
                ...
                <div class="px-5 py-5 space-y-3">
                    <form method="POST" action="{{ route('survei.sesi3.draft', $sesi->id) }}">
                        @csrf
                        <button type="submit"
        ...
        <div class="min-h-full flex items-center justify-center p-4">
            <div class="relative w-full max-w-2xl rounded-md border border-paper-300 bg-paper-50 shadow-2xl" onclick="event.stopPropagation()">
                ...
                <div class="flex items-center justify-between border-b border-paper-200 bg-paper-100/90 px-5 py-4 rounded-t-md">
                    <div>
                        <h3 id="modal-standar-title" class="font-display text-base font-semibold text-ink-900">Isi Standar Konsumsi</h3>
                ...
                <form id="form-standar" method="POST" action="" class="p-5 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" id="form-sumber-lainnya" name="sumber_standar_lainnya"
                                   ...
                                   class="w-full mt-1 rounded-sm border border-paper-300 bg-white px-3 py-2 text-xs focus:border-merah-400 focus:outline-none hidden">
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-ink-800 mb-1">
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" id="form-keterangan" rows="2"
                                  ...
                                  class="w-full rounded-sm border border-paper-300 bg-white px-3 py-2 text-xs focus:border-merah-400 focus:outline-none resize-none"></textarea>
                    </div>
    ...
    <div id="modal-selesaikan"
        ...
        <div class="w-full max-w-sm rounded-sm border border-paper-300 bg-paper-50 shadow-xl">
            <div class="px-6 py-6 text-center">
                ...
                <form method="POST" action="{{ route('survei.sesi3.selesaikan', $sesi->id) }}">
                    @csrf
    ...
    <script>
        ...
        const storeUrl      = "{{ route('survei.sesi3.standar.store', $sesi->id) }}";
        ...
        function toggleSumberLainnya(sel) {
            const lainnyaInput = document.getElementById('form-sumber-lainnya');
            if (sel.value === 'Lainnya') {
                lainnyaInput.classList.remove('hidden');
                lainnyaInput.required = true;
                sel.name = '';
                lainnyaInput.name = 'sumber_standar';
            } else {
                lainnyaInput.classList.add('hidden');
                lainnyaInput.required = false;
                sel.name = 'sumber_standar';
                lainnyaInput.name = 'sumber_standar_lainnya';
            }
        }
